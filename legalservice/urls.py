...
urlpatterns = [
    ...
    path('auth/login/', views.LegalAccessTokenObtainPairView.as_view(), name='token_obtain_pair'),
    path('auth/refresh/', views.LegalRefreshTokenObtainPairView.as_view(), name='token_refresh'),
